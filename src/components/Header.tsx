import React, { CSSProperties, Children, Dispatch, SetStateAction } from "react";
            ...
            <div style={bannerStyle}>
                ...
                { 
                    Children.map(children, Child => {
                        const styleProp: { style: object; }= { style: bannerItemStyle };
                        if (React.isValidElement(Child)) {return React.cloneElement(Child, styleProp)};
                        return Child;
                    })
                }
            </div>
